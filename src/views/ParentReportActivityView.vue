...
<template>
    <div class="flex justify-between mx-6">
        <RouterLink to="/reportParent" class="flex bg-green-200 hover:bg-green-300 p-8 w-2/5 mt-10 m-4 rounded-2xl justify-center cursor-pointer drop-shadow-2xl">
            ...
            <RouterLink to="/reportParent/activity" class="flex bg-[#93c5fd] hover:bg-blue-400 p-8 w-2/5 mt-10 m-4 rounded-2xl justify-center cursor-pointer drop-shadow-2xl">
